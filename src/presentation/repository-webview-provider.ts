...
export class RepositoryWebviewProvider implements vscode.WebviewViewProvider {
  ...
  public constructor(
    ...
    private readonly openIntegration: (repositoryId: string) => Promise<void>,
  ...
  private async handleMessage(value: unknown): Promise<void> {
    ...
    try {
      if (typeof message.repositoryId === "string" && message.type === "open" && message.repositoryId.startsWith("integration:")) await this.openIntegration(message.repositoryId.slice("integration:".length));
      ...
      else if (typeof message.repositoryId === "string" && message.type === "openIntegration") await this.openIntegration(message.repositoryId);
