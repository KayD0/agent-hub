...
import { FolderAnalysisCandidate, FolderAnalysisDepth, FolderAnalysisScope, parseFolderAnalysisResult } from "../domain/folder-analysis";
...
export class FolderAnalysisPanel implements vscode.Disposable {
  ...
  public showSession(sessionId: string): void {
    ...
    }, session.id, origin.scope ?? "all", origin.depth ?? "standard");
  }
